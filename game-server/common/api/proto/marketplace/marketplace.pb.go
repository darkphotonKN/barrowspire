...
const file_api_proto_marketplace_marketplace_proto_rawDesc = "" +
	...
	"\x06bid_id\x18\x01 \x01(\tR\x05bidId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12#\n" +
	"\rcurrent_price\x18\x03 \x01(\x03R\fcurrentPrice2\xd8\x02\n" +
	"\x12MarketplaceService\x12I\n" +
	"\bListItem\x12\x1c.marketplace.ListItemRequest\x1a\x1d.marketplace.ListItemResponse\"\x00\x12X\n" +
...
var file_api_proto_marketplace_marketplace_proto_goTypes = []any{
	...
	(*CreateListingRequest)(nil),  // 3: marketplace.CreateListingRequest
	(*CreateListingResponse)(nil), // 4: marketplace.CreateListingResponse
...
var file_api_proto_marketplace_marketplace_proto_depIdxs = []int32{
	...
	9,  // 1: marketplace.Listing.create_at:type_name -> google.protobuf.Timestamp
	...
	9,  // 7: marketplace.CreateListingResponse.created_at:type_name -> google.protobuf.Timestamp
	1,  // 8: marketplace.MarketplaceService.ListItem:input_type -> marketplace.ListItemRequest
	3,  // 9: marketplace.MarketplaceService.CreateListing:input_type -> marketplace.CreateListingRequest
	5,  // 10: marketplace.MarketplaceService.PlaceBid:input_type -> marketplace.PlaceBidRequest
	7,  // 11: marketplace.MarketplaceService.WithdrawBid:input_type -> marketplace.WithdrawBidRequest
	2,  // 12: marketplace.MarketplaceService.ListItem:output_type -> marketplace.ListItemResponse
	4,  // 13: marketplace.MarketplaceService.CreateListing:output_type -> marketplace.CreateListingResponse
	6,  // 14: marketplace.MarketplaceService.PlaceBid:output_type -> marketplace.PlaceBidResponse
	8,  // 15: marketplace.MarketplaceService.WithdrawBid:output_type -> marketplace.WithdrawBidResponse
