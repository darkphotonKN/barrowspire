...
import (
	...
	"github.com/darkphotonKN/barrowspire-server/example-service/config"
	"github.com/darkphotonKN/barrowspire-server/example-service/internal/example"
...
var (
	...
	grpcAddr    = commonhelpers.GetEnvString("GRPC_EXAMPLE_ADDR", "7123")
