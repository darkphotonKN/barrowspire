...
//
// SCAFFOLD: nothing calls withRetry yet — CreateLedger is an insert, not a
// load-modify-save. The first use case that reads then writes the aggregate wraps
// its whole load/modify/save closure in it.
