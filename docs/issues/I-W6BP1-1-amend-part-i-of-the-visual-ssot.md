...
blocked_by: []
labels: []
title: "FS-W6BP1 slice 1: amend Part I — gameplay accent channels, typography, lighting rule"
---
Implements FS-W6BP1 §Requirements 1-5
...
> **No code changes in this slice.** One document. Every other FS-W6BP1 slice is blocked on it.

## What to Build

Part I of `game-client/docs/design-guideline.md` describes a pixel-art game that does not exist
yet, and gives gameplay **no accent rule at all**. FS-SWMNW amended Part II and left this half
...
`image-rendering: pixelated`. FS-W6BP1 does **not** discharge these. The guideline must not read as
...
None. Head of the FS-W6BP1 chain.

## Spec Reference

FS-W6BP1 §Requirements 1-5 (§A. Amend Part I of the visual SSOT); §User Stories 4, 5, 6, 8, 21;
