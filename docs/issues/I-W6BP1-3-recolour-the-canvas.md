...
status: done
implements: FS-W6BP1
blocked_by: [I-W6BP1-2]
labels: [blocked]
title: "FS-W6BP1 slice 3: recolour all 377 canvas sites onto the semantic palette"
---
Implements FS-W6BP1 §Requirements 14-18, 23-24
...
- **mint:** `0x4ecca3` (8×) — the same residue FS-SWMNW cleared from the web CSS
...
Amber appears **65 times**. This is not a reduction target — I-W6BP1-1's rule says amber means
...
1. **`createHullTexture` was already a dungeon stone wall** — brick courses, mortar, moss, cracks —
   from an earlier theming pass that left the sci-fi name. FS-W6BP1's audit assumed the canvas was
   unstyled; it was partly done already, which is why this pass reads as a small change.
2. **This is the same blind spot recorded in I-W6BP1-5** ("hex-free colour is still colour"). It was
...
I-W6BP1-2 — consumes the palette module and the font constant.

## Spec Reference

FS-W6BP1 §Requirements 14-18, 23-24 (§D. Recolour the canvas, §F. Voice); §User Stories 3, 4, 5, 6,
