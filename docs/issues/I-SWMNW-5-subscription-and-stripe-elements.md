...
labels: [blocked]
title: "FS-SWMNW slice 5: subscription — re-theme Stripe Elements, keep money copy plain"
---
Implements FS-SWMNW §Requirements 15, 22, 37
...
owns. Derive every value from the tokens (I-SWMNW-2).
...
I-SWMNW-2 — consumes its tokens and material primitives.

Independent of I-SWMNW-3 and I-SWMNW-4; may run concurrently with both.

## Spec Reference

FS-SWMNW §Requirements 15, 22, 37; §User Stories 13, 14; §Edge States (Stripe Elements refuses a
value).
