...
title: "FS-F9R7Q slice 2: service scaffold — wiring, Docker, compose (error mapping STRIPPED)"
---
Implements FS-F9R7Q §Requirements 17, 19
...
- it carries exactly one `TODO` pointing at **I-F9R7Q-8 (slice 8)**
...
- [ ] Exactly one TODO in `mapError`, naming I-F9R7Q-8
- [ ] `make lint` green

## Blocked By

I-F9R7Q-1 — the sentinel set must exist before the stub can reference it.

## Spec Reference

FS-F9R7Q §Requirements 17 (scaffold retirement), 19 (the write path is a Temporal activity — no
...
intended end state until I-F9R7Q-8.
