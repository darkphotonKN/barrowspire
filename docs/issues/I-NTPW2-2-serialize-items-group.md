...
status: done
implements: FS-NTPW2
blocked_by: [I-NTPW2-1]
labels: [ready-for-agent]
title: "FS-NTPW2 slice 2: serialize the items group (11 routes)"
---
Implements FS-NTPW2 §Requirements 5-7, 16, §API surface
...
I-NTPW2-1 (the mount, the identity bridge, and the error adapter must exist first).

## Spec Reference

FS-NTPW2 §Requirements 5-7 (the transcription rule, per-operation transport types), 16
...
From I-22WKC-4: three item handlers used to compute a status and discard it, and three had no
