...
blocked_by: []
labels: []
title: "FS-SWMNW slice 1: amend the visual SSOT — typography, material, accent rule, lifted bases"
---
Implements FS-SWMNW §Requirements 1-6
...
> **No code changes in this slice.** Two documents only. Every other FS-SWMNW slice is blocked on
...
in its first paragraph, and the guideline wins over any other document. So FS-SWMNW deliberately
...
with vellum text, and I-SWMNW-6 measures against this floor. A lift with no stated floor cannot be
...
so explicitly** — otherwise two rules sit in silent contradiction and whoever implements I-SWMNW-4
picks one at random.
...
None. This is the head of the FS-SWMNW chain.

## Spec Reference

FS-SWMNW §Requirements 1-6 (§A. Amend the visual SSOT); §User Stories 23, 26; §Risks and fallbacks
