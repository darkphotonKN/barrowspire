...
status: done
implements: FS-SWMNW
blocked_by: [I-SWMNW-3, I-SWMNW-4, I-SWMNW-5]
labels: [blocked]
title: "FS-SWMNW slice 6: accessibility and degradation — measure contrast, honour user preferences"
---
Implements FS-SWMNW §Requirements 30-34

**Author: human** — do NOT hand this to `/develop`. The contrast work may conclude that a token
value has to move, which is a change to I-SWMNW-1's authored palette, not a local fix. That is a
decision, not a task.
...
Report the measured ratios against the contrast floor I-SWMNW-1 stated. **If a token falls below it,
...
- [ ] Every measured ratio meets I-SWMNW-1's stated floor, or the token was moved and re-measured
...
I-SWMNW-3, I-SWMNW-4, I-SWMNW-5 — verifies the finished surface, so every view must be reskinned first.

## Spec Reference

FS-SWMNW §Requirements 30-34; §User Stories 12, 17, 18, 19, 21; §Edge States (material layer under
