...
title: "FS-NTPW2 slice 4: serialize the payment group (5 routes, webhook fenced out)"
---
Implements FS-NTPW2 §Requirements 5-7, 16, §Out of Scope
...
FS-NTPW2 §Requirements 5-7, 16, §Out of Scope (the webhook fence, verbatim).

## Notes

I-22WKC-6 already migrated this group's 10 error writes to the seam and deleted its private
