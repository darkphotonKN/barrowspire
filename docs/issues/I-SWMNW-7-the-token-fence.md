...
status: done
implements: FS-SWMNW
blocked_by: [I-SWMNW-6]
labels: [blocked]
title: "FS-SWMNW slice 7: the token fence — reject raw hex, and prove it rejects"
---
Implements FS-SWMNW §Requirements 10, 39-41 · Realizes ADR-0013

The gate that makes the reskin survive. Lands **last**, once the tree can actually go green.

> Without this slice, FS-SWMNW is a one-time cleanup that decays exactly the way the last one did.
...
**the exemption is the bug** — find the call site I-SWMNW-2 through I-SWMNW-5 missed and fix it. An
...
I-SWMNW-6 — and transitively every reskin slice. The fence cannot precede the work it protects; a
gate introduced against a red tree gets an allowlist.

## Spec Reference

FS-SWMNW §Requirements 10, 39-41; §User Stories 22, 24, 25; §Edge States (a raw hex is genuinely
