...
status: done
implements: FS-9KW9F
blocked_by: [I-9KW9F-2]
labels: [ready-for-agent]
title: "FS-9KW9F slice 3: wallet creates the account on signup and announces it"
---
Implements FS-9KW9F §Requirements 11-14, 16, 17, 20
...
- [x] The outbox worker is wired in `cmd/server/main.go` on the same 5s/20 cadence, publishing
      ...
      end to end; that needs a live broker and is first proven when I-9KW9F-4 consumes the event.
...
I-9KW9F-2 — needs `common/inbox`.

## Spec Reference

FS-9KW9F §Requirements 11 (consume signup), 12 (transactional outbox), 13 (`wallet.events`),
