...
status: done
implements: FS-W6BP1
blocked_by: [I-W6BP1-3]
labels: [blocked]
title: "FS-W6BP1 slice 4: lighting — static vignette and a torch pool that follows the delver"
---
Implements FS-W6BP1 §Requirements 19-22
...
I-W6BP1-1 states a readability floor. This slice proves it in a running game:
...
I-W6BP1-3 — readability can only be judged against the recoloured world, and both slices edit
`BarrowspireScene.ts`.

## Spec Reference

FS-W6BP1 §Requirements 19-22 (§E. Lighting); §User Stories 2, 12, 13; §Edge States (the overlay
