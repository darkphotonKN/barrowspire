...
title: "FS-22WKC slice 2: middleware error paths — JWT and panic recovery"
---
Implements FS-22WKC §Requirements, §Edge States
...
4 error writes, all 401. **Replaced outright, not forked** (FS-22WKC §Requirements 11): every
...
I-22WKC-1 — the seam must exist and must be callable from a middleware context.

## Spec Reference

FS-22WKC §Requirements 11 (JWT replaced outright), §Edge States (missing/expired/malformed JWT;
